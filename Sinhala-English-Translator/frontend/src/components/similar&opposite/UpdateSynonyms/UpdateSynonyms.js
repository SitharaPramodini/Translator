...
export default function UpdateSynonyms() {
  ...
  return (
    <div className="BodyU">
      ...
      <div className="table-container">
        <table className="sy-table" id="table">
          <tr>
            <th >number</th>
            <th >Word</th>
            <th style={{ width: '400px' }}>Synonyms</th>
            <th >Update</th>
            <th >Delete</th>
          </tr>
          {synonyms && synonyms.map((synonym, index) => (
            <tr>
              ...
              <td className="td">
                {/* <span><p key={synonym._id}>{synonym.synonym}</p></span> */}
                <input
                  className="td-input"
                  key={synonym._id}
                  disabled
      ...
      <button className="add-button" onClick={dowPDF} type="button">synonyms list</button>
